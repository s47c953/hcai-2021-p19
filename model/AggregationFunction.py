...
class TnormTconormArithmeticAggregationFunction(AggregationFunction):
    ...
    def perform(x: float, y: float, l: float = 1, r: float = 1) -> float:
        if x < 0.5 and y < 0.5:
            return TnormTconormArithmeticAggregationFunction._noFunction(x, y, l, r)
        elif x < 0.5 or y < 0.5:
            return TnormTconormArithmeticAggregationFunction._maybeFunction(x, y, l, r)
        elif x >= 0.5 and y >= 0.5:
            return TnormTconormArithmeticAggregationFunction._yesFunction(x, y, l, r)
